...
namespace rocketfellows\SIVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\SIVatNumberFormatValidatorsConfig\SIVatNumberFormatValidatorsConfig;

class SIVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = SIVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = SIVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::SI(), $config->getCountry());
    }
